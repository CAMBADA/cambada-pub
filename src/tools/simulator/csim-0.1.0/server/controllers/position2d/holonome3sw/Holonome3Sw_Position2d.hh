 ...
 * Date: 21 Feb 2007
 * SVN: $Id: Holonome3Sw_Position2d.hh 8357 2009-11-03 18:05:44Z natepak $
 */
...
class Holonome3Sw_Position2d : public Controller
{
  ...
  /// Calculate position and rotation using odometry       
  ...
  //
  private: bool userVelocities;
  private: Vector3 xya;

  // Simulation time of the last update
  private: Time prevUpdateTime;

  private: HolonomicMotion hm;
  private: int selfID;
