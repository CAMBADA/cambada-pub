...
/// \brief A stubbed out controller.
class Kicker : public Controller
{ 
     
  /// Constructor
  public: Kicker(Entity *parent );

  /// Destructor
  public: virtual ~Kicker();
...
private:
    ...
    float kickerTilt; // kicker tilt
    
    float highDistance; // High kick maximum distance without bounce
    float highVel;
    float lowVel;
