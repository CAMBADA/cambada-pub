 ...
 * Author: Nate Koenig
 * Date: 11 June 2007
 * SVN: $Id: ODEPhysics.cc 8480 2009-12-22 18:08:45Z natepak $
 *
  ...
  else
  {
    ...
    if (numc != 0)
    {
      ...
      for (i=0; i<numc; i++)
      {
        ...
        contact.surface.mode =  dContactSlip1 | dContactSlip2 | dContactSoftERP | 
        ...
        contact.fdir1[0] = 0; contact.fdir1[1] = 0; contact.fdir1[2] = 1;
