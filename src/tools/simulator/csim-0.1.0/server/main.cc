 ...
 * Author: Nate Koenig
 * Date: 3 Apr 2007
 * SVN: $Id: main.cc 7919 2009-06-27 01:46:18Z natepak $
 *
...
void PrintUsage()
{
  fprintf(stderr, "Usage: csim [-hv] <worldfile>\n");
...
void PrintVersion()
{
  fprintf(stderr, "CAMBADA Robocup Middle Size League Simulator, version %s\n", CSIM_VERSION);
  fprintf(stderr, "Universidade de Aveiro 2010\n\n");
...
int ParseArgs(int argc, char **argv)
{
  ...
  char *flags = (char*)("l:hd:s:fxt:nqperu");
...
int main(int argc, char **argv)
{
  ...
  try
  {
    ...
    visual::VisualApp::Instance()->SetEnabled( optRenderEngineEnabled );
  }
  ...
  try
  {
    ...
    gazebo::Referee::Instance()->Init();
    if ( optRenderEngineEnabled )
      visual::VisualApp::Instance()->Init();
  ...
  catch (gazebo::GazeboError e)
  {
    ...
    std::cerr << e << std::endl;
    gazebo::Simulator::Instance()->Fini();
    visual::VisualApp::Instance()->Fini();
